...
const ClientDashboard = () => {
  ...
  const getImagen = (producto: Producto) => {
    ...
    if (nombre.includes('sensor') && nombre.includes('movimiento')) return '/imagenes/Sensor-pir.jpg';
    if (nombre.includes('controlador')) return '/imagenes/controladorj.jpg';
    if (nombre.includes('cinta led')) return '/imagenes/led-rgb.jpg';
    ...
    if (nombre.includes('batería')) return '/imagenes/bateria-18650.jpg';
    if (nombre.includes('robot')) return '/imagenes/Robot1.jpg';
    if (nombre.includes('alexa')) return '/imagenes/alexa.jpg';
    if (nombre.includes('sensor') && nombre.includes('puerta')) return '/imagenes/sensor-puerta.jpg';
  ...
  const currentProductos = productos.slice(startIndex, startIndex + itemsPerPage);
        ...
        <section className="productos">
          <div className="barra-superior">
            <div className="buscador">
              ...
              <span className="icono-micro">🎤</span>
            </div>
